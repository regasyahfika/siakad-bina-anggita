        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
              ...
              <a href="{{ route('laporan_absensi.index') }}" class="btn btn-sm btn-info"><i class="fa fa-undo"></i> Kembali</a>
                 ...
                 @foreach ($kelasSiswa as $dataKelasSiswa)
                  <tr>
                    ...
                    <td style="text-align: center;">
                      <a href="{{ route('laporan_absensi.export', ['tahun' => $tahun->id_tahun, 'siswa' => $dataKelasSiswa->siswa->id_siswa]) }}" class="btn btn-xs btn-success"><i class="fa fa-print"></i> Cetak</a>
                    </td>
                  </tr>
