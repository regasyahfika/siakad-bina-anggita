                 ...
                 @foreach ($tahun as $dataTahun)
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('ulangansiswa.status', $dataTahun->id_tahun) }}" class="btn btn-xs btn-warning"><i class="fa fa-check-square-o"></i> Aktifkan</a>
                      @else
                      <a href="" class="btn btn-xs btn-primary disabled"><i class="fa fa-check-circle"></i> Aktif</a>
                      @endif
                    </td>
                    <td style="text-align: center;">
                      <a href="{{ route('ulangansiswa.tampil', $dataTahun->id_tahun) }}" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Tambah Ulangan</a>
                    </td>
                  </tr>
                  @endforeach
              </tbody>
