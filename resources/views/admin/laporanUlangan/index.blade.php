                ...
                <tbody>
                 @foreach ($tahun as $dataTahun)
                  <tr>
                    ...
                    <td>
                      {{-- <button class="btn btn-xs btn-info">{{ $dataTahun->status == 1 ? 'Aktif' : 'Tidak Aktif' }}</button> --}}
                      @if ($dataTahun->status==0)
                      <a href="{{ route('laporan_ulangan.status', $dataTahun->id_tahun) }}" class="btn btn-xs btn-warning"><i class="fa fa-check-square-o"></i> Aktifkan</a>
                      @else
                    ...
                    <td style="text-align: center;">
                      <a href="{{ route('laporan_ulangan.tampil', $dataTahun->id_tahun) }}" class="btn btn-xs btn-primary"><i class="fa fa-eye"></i> Lihat Laporan</a>
