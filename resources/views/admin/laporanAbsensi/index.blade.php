                 ...
                 @foreach ($tahun as $dataTahun)
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('laporan_absensi.status', $dataTahun->id_tahun) }}" class="btn btn-xs btn-warning"><i class="fa fa-check-square-o"></i> Aktifkan</a>
                      @else
                    ...
                    <td style="text-align: center;">
                      <a href="{{ route('laporan_absensi.tampil', $dataTahun->id_tahun) }}" class="btn btn-xs btn-primary"><i class="fa fa-eye"></i> Lihat Laporan</a>
